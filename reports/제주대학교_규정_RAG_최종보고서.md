...
조항 청킹은 `제1조`, `제2조`, `제2조의2` 등 조 번호 패턴을 기준으로 수행하였다. 기존 baseline은 조항 원문 중심의 `articles.jsonl`을 생성하였다. 이후 개선 실험을 위해 `articles_contextual.jsonl`을 별도로 생성하였다. 이 파일은 기존 baseline을 덮어쓰지 않으며, 각 조항에 `embedding_text`와 `display_text`를 분리해 저장한다. 최종 contextual 말뭉치에는 5317개 조항이 포함되었고, 부칙 후보는 631개로 파악되었다.
...
| --- | --- | --- | --- | --- | --- |
| Baseline Dense | 0.8800 | 0.9700 | 1.0000 | 0.9292 | - |
| Contextual Dense | 0.8800 | 0.9600 | 1.0000 | 0.9262 | - |
| Contextual Hybrid | 0.8800 | 0.9800 | 1.0000 | 0.9300 | 0.9 |
...
| --- | --- | --- | --- | --- | --- | --- |
| FP16 | 0.8800 | 0.8980 | 0.8400 | 4.0016 | 33.5938 | 17.398 |
| INT8 | 0.8800 | 0.8960 | 0.8800 | 7.4312 | 19.1897 | 11.746 |
| INT4 | 0.8000 | 0.8700 | 0.7600 | 2.5760 | 50.9247 | 8.996 |
